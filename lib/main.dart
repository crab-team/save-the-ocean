...
import 'package:save_the_ocean/data/repositories/in_memory_ranking_repository.dart';
import 'package:save_the_ocean/domain/repositories/ranking_repository.dart';
import 'package:save_the_ocean/domain/use_cases/get_ranking.dart';
...
class MyGame extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    RankingRepository rankingRepository = InMemoryRankingRepository();
