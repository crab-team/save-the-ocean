...
//     currentPlayer.play(AssetSource('${AudioAssets.sfxFolder}/$filename'), volume: soundTypeToVolume(type));
...
//     try {
//       await _musicPlayer.play(AssetSource('${AudioAssets.musicFolder}/${_playlist.first.filename}'));
//     } catch (e) {
...
//         .loadAll(SfxType.values.expand(soundTypeToFilename).map((path) => '${AudioAssets.sfxFolder}/$path').toList());
//   }
